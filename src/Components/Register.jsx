    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            if (error.code === 'auth/invalid-email') {
                setRegError('Invalid email address. Please enter a valid email.');
            } else {
                setRegError('An error occurred during registration. Please try again later.');
            }
        }
                ...
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleRegister} className="card-body bg-green-50">
                        ...
                        <div className="form-control relative">
                            ...
                            <input type={showPass ? "text" : "password"} placeholder="password" name="password" className="input input-bordered pr-10" required />
                            <button
                                type="button"
